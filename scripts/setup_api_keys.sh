...
echo "================================================================="
echo " Mini Software House V8.5 — Secure API key setup"
echo "================================================================="
echo
...
write_env_file() {
    ...
    {
        echo "# Mini Software House V8.5 — generated by setup_api_keys.sh"
        ...
        if [ -f "$target" ]; then
            ...
            while IFS= read -r line; do
                case "$line" in
                    "# Mini Software House V8.5 — generated by setup_api_keys.sh") in_old_header=1; continue ;;
